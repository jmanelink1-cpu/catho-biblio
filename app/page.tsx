...
import { IMG, SHOWCASE, VALUES, STEPS, TESTIMONIALS, FAQS } from '@/lib/landing'
    ...
    <div style={{ background: IVORY, color: INK, fontFamily: 'var(--font-inter), sans-serif', overflowX: 'hidden' }}>
      <style>{`
        ...
        @media (max-width:768px){
          ...
          .hero-wrap{ min-height:auto !important; padding-top:96px !important; padding-bottom:40px !important; }
